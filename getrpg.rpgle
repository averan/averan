      ...
      * XXXXXXX: Nombre de la librería en donde está el fuente
      *> CRTRPGMOD MODULE(XXXXXXX/GETRPG) SRCFILE(QRPGLESRC) DBGVIEW(*LIST)
      *> CRTPGM PGM(XXXXXXX/GETRPG) BNDSRVPGM(QHTTPSVR/QZHBCGI) ACTGRP(XXXXXX)
